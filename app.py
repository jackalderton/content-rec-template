...
st.markdown(
    ...
    "\n"
    "/* Sidebar look + width */\n"
    "[data-testid=\"stSidebar\"] { background-color: #1a1e24; border-right: 1px solid #4A90E2; min-width: 450px; max-width: 8000px; }\n"
    "\n"
    "/* Expander headers */\n"
...
if url.strip().lower() == "goatmodeactivated":
    ...
    if goat_image_path.exists():
        ...
        st.image(str(goat_image_path), caption="The GOAT has arrived.", use_container_width=True)
    else:
